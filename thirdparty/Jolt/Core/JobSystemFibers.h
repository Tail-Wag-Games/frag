...
class JobSystemFibers final : public JobSystemWithBarrier
{
public:
	JPH_OVERRIDE_NEW_DELETE

	/// Creates a thread pool.
	/// @see JobSystemFibers::Init
							JobSystemFibers(uint inMaxJobs, uint inMaxBarriers, int inNumThreads = -1);
							JobSystemFibers() = default;
	virtual					~JobSystemFibers() override;
